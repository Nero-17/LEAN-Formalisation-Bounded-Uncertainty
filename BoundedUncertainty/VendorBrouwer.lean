...
Released under the MIT license in third-party/Harfe-MIT.txt.
Upstream: https://github.com/harfe/fixed-point-theorems-lean4
Commit: 770940ddf9878cf61952ed53d910b92bca841838
Original file: FixedPointTheorems/brouwer.lean
Project adaptation: namespace/import isolation for Lean 4.28.0.
See third-party/README.md for the exact compatibility patch and source hashes.
-/


import BoundedUncertainty.VendorSpernerApplication
import BoundedUncertainty.VendorConvexHomeomorphisms
import Mathlib.Dynamics.FixedPoints.Basic

namespace BoundedUncertainty.Vendor
